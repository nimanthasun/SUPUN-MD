...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=iR8DHBhR#MdrGD0on2hzuc739LoFojPCqGXXwRcjfRhKSyh7BFmw' : process.env.SESSION_ID,
...
AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG === undefined ? "`𝒀𝒐𝒖𝒓 𝒔𝒕𝒂𝒕𝒖𝒔 𝒔𝒆𝒆𝒏 𝒋𝒖𝒔𝒕 𝒏𝒐𝒘 𝒃𝒚 ♥️🌸⃝රොකී᭡👑`" : process.env.AUTO_STATUS__MSG,
